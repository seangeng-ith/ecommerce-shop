...
$total = 0; foreach($items as $it){ $total += $it['subtotal']; }
?>
<section class="container pad cart">
  ...
  <form method="post">
    <table class="cart-table">
        ...
        <?php foreach($items as $it): ?>
          <tr>
            <td class="prod-cell">
              ...
              <a class="remove" href="<?= base_url('index.php?page=cart&remove=' . urlencode($it['id'])) ?>">Remove</a></div>
            </td>
            <td class="qty-cell">
      ...
      <tfoot>
        <tr><td></td><td class="money label">Subtotal</td><td class="money"><?= money($total) ?></td></tr>
      </tfoot>
    </table>
